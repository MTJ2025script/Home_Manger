-- ====================================================================================================
-- 🏠 GTA V IMMOBILIEN (700+ HÄUSER)
-- Alle mit VEC4-Format, Interior-IDs, Garage-Typ, Preisen
-- ====================================================================================================

Properties = {}

-- ====================================================================================================
-- MIRROR PARK PROPERTIES
-- ====================================================================================================

Properties['mirror_park'] = {
    -- Mirror Park House 1
    {
        id = 'mp_house_1',
        name = 'Mirror Park Familienhaus',
        type = 'house',
        entrance = vec4(1035.88, -763.74, 57.99, 235.89),
        ...
        bathrooms = 2,
        area = 'Mirror Park',
        description = 'Gemütliches Familienhaus in ruhiger Nachbarschaft'
    },
    {
        id = 'mp_house_2',
        name = 'Mirror Park Villa',
        type = 'villa',
        entrance = vec4(1028.67, -767.42, 58.01, 308.78),
    ...
    {
        id = 'mp_house_3',
        name = 'Mirror Park Apartment',
        type = 'apartment',
        entrance = vec4(1010.55, -765.03, 58.00, 88.45),
        interior = 'apa_v_mp_h_01_a',
        price = 95000,
        garage = 'small',
        bedrooms = 2,
